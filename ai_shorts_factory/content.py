...
def generate_hooks(topic: str) -> str:
    ...
    prompt = (
        ...
        "NEVER start with 'What if', 'Did you know', 'Have you ever' or any "
        "slow/generic question. Open with a high-stakes, shocking or "
        "fear-inducing STATEMENT addressed to the viewer (e.g. 'You are "
        "currently sitting in the most terrifying silence in the universe').\n"
...
def generate_script(topic: str) -> list[Scene]:
    ...
    prompt = (
        ...
        "'picture this', 'What if', 'Did you know', or any slow setup or generic "
        "question — open with a high-stakes, shocking or fear-inducing STATEMENT "
        "aimed directly at the viewer. Scene 1's image_prompt MUST describe "
