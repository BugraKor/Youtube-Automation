...
def generate_script(topic: str) -> list[Scene]:
    ...
    prompt = (
        ...
        "Rules:\n"
        f"- Exactly {n} scenes.\n"
        "- Scene 1 is a punchy HOOK that creates an open loop in <12 words.\n"
        "- Each narration line is 1-2 short sentences, conversational, spoken aloud.\n"
        "- Build escalating tension; end with a thought-provoking or ominous line.\n"
        f"- Language: {settings.content_language}.\n"
        "- For each scene also write a vivid, cinematic AI IMAGE PROMPT (English, "
        "photorealistic, dramatic lighting, vertical 9:16 composition, no text).\n"
